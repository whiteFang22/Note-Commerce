      ...
      <div className="flex justify-center gap-3 p-3 bg-slate-200 my-3 rounded-xl px-10 fixed bottom-[5px] z-30">
         ...
         <button onClick={zoomOut}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
               ...
               <path fillroule="evenodd" d="M9 2a7 7 0 104.391 12.452l3.329 3.328a.75.75 0 101.06-1.06l-3.328-3.329A7 7 0 009 2zM3.5 9a5.5 5.5 0 1111 0 5.5 5.5 0 01-11 0z" cliproule="evenodd" />
            </svg>
         </button>
         ...
         <button onClick={zoomIn}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
               ...
               <path fillroule="evenodd" d="M2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9zm7-5.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11z" cliproule="evenodd" />
            </svg>
         </button>
      </div>
   )
