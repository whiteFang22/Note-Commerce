               ...
               <div className="flex basis-2/4">
                  ...
                  <div className="ml-4 flex flex-col ">
                     <div className='line-clamp-2'>
                        <Link to="/document" className="hover:underline text-blue-400">Riassunto del libro "Manuale di storia greca" di Cinzia Bearzot - Storia greca a.a. 2015/2016</Link>
                     </div>
                     <div className="flex">
