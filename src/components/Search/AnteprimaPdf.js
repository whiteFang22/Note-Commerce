...
function AnteprimaPdf(props) {
   return (
      <div class="border-y hover:bg-sky-50">
         <ul className='mx-10'>
            <li class="flex md:flex-row flex-col p-4 rounded-lg md:gap-16">
               ...
               <div className='flex gap-2 md:flex-1 md:justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-6 ml-24 md:ml-0">
               ...
               <div className='flex gap-2 md:flex-1 md:justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 inline fill-green-400 ml-24 md:ml-0">
